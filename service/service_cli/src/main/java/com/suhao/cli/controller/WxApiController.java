...
import com.suhao.cli.utils.HttpClientUtils;
import com.suhao.cli.utils.WxUtils;
...
public class WxApiController {
    ...
    public String callback(String code, String state) {
        try {
            ...
            Client member = clientService.getOpenIdMember(openid);
